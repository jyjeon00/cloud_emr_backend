...
//    private String treatmentComment;
    ...
    public TreatmentRequest() {
        this.treatmentStatus = "진료전"; // 기본값
        this.treatmentDept = "배정되지 않음"; // 기본값
        this.treatmentDoc = "배정되지 않음"; // 기본값
    }

    //TreatmentEntity로 변환시킴
    public TreatmentEntity toTreatmentEntity(CheckInEntity checkInEntity, TreatmentFeeEntity treatmentFeeEntity) {
        return TreatmentEntity.builder()
                .checkInEntity(checkInEntity)
                .treatmentFeeEntity(treatmentFeeEntity)
